...
# Input argument: the name of the dataset
dataset = sys.argv[1] # "DR_RATES-N2-N2-dis"

# Slicing of the dataset name
folder  = dataset[9:14]
...
# The temperature arrays is always the same, so I read it from one generic folder
